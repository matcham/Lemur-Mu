{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 40.0, 118.0, 722.0, 552.0 ],
		"bglocked" : 0,
		"defrect" : [ 40.0, 118.0, 722.0, 552.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 68.0, 335.0, 271.0, 20.0 ],
					"text" : "Mu.deviceParameter #1 Width(Random) #2"
				}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 35.0, 105.0, 831.0, 377.0 ],
						"bglocked" : 0,
						"defrect" : [ 35.0, 105.0, 831.0, 377.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
, 							{
								"box" : 								{
									...
									"text" : "Mu.lemurClient #1/Waveform4/x #2"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "Mu.lemurClient #1/Waveform3/x #2"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "Mu.lemurClient #1/Waveform2/x #2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 33.5, 179.5, 186.0, 34.0 ],
									"text" : "Mu.lemurClient #1/Waveform1/x #2"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "Mu.deviceParameter #1 Waveform #2"
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-8", 1 ],
									"hidden" : 0,
									"midpoints" : [ 43.5, 324.0, 27.0, 324.0, 27.0, 36.0, 196.5, 36.0 ],
									"source" : [ "obj-28", 0 ]
								}
...
,
					"patching_rect" : [ 48.0, 516.0, 91.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 192.0, 367.0, 903.0, 532.0 ],
						"bglocked" : 0,
						"defrect" : [ 192.0, 367.0, 903.0, 532.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
, 							{
								"box" : 								{
									...
									"text" : "Mu.lemurClient #1/LFOType/x #2"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "Mu.lemurClient #1/Rate/x #2"
								}
...
,
					"patching_rect" : [ 44.0, 232.0, 77.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontsize" : 12.0,
						"globalpatchername" : "",
						"fontface" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 47.0, 139.0, 193.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 48.0, 160.0, 277.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 47.0, 425.0, 185.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 48.0, 35.0, 205.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 50.0, 284.0, 185.0, 20.0 ],
					"text" : "Mu.lemurClient #1/phase/x #2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 48.0, 80.0, 301.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 47.0, 448.0, 271.0, 20.0 ],
					"text" : "Mu.deviceParameter #1 Shape #2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 50.0, 308.0, 271.0, 20.0 ],
					"text" : "Mu.deviceParameter #1 Phase #2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 462.0, 259.0, 210.0, 156.0 ],
					"text" : "DeviceOn, 71 0. 1. \"Device On\";\nLFOType, 72 0. 1. \"LFO Type\";\nAmount, 73 0. 1. Amount;\nFrequency, 74 0. 1. Frequency;\nSyncRate, 75 0. 21. \"Sync Rate\";\nPhase, 76 0. 360. Phase;\nSpin, 77 0. 0.5 Spin;\nStereoMode, 78 0. 1. \"Stereo Mode\";\nOffset, 79 0. 360. Offset;\nWaveform, 80 0. 3. Waveform;\nShape, 81 0. 1. Shape;\nWidth(Random), 82 0. 1. \"Width (Random)\";\nInvert, 83 0. 1. Invert;\n"
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					"destination" : [ "obj-51", 0 ],
					"hidden" : 0,
					"midpoints" : [ 77.5, 378.0, 33.0, 378.0, 33.0, 265.0, 59.5, 265.0 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-51", 0 ],
					"hidden" : 0,
					"midpoints" : [ 59.5, 371.0, 44.5, 371.0, 44.5, 274.0, 59.5, 274.0 ],
					"source" : [ "obj-28", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 57.5, 190.0, 42.5, 190.0, 42.5, 128.0, 56.5, 128.0 ],
					"source" : [ "obj-34", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 56.5, 477.0, 42.5, 477.0, 42.5, 415.0, 56.5, 415.0 ],
					"source" : [ "obj-37", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 57.5, 105.0, 42.0, 105.0, 42.0, 29.0, 57.5, 29.0 ],
					"source" : [ "obj-48", 0 ]
				}
