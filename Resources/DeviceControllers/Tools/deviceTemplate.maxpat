...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 284.0, 232.0, 91.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "This abstraction communicates with the Live API. It is already setup to talk with the device you choose from the Devices Browser. The '#1' and '#2' arguments are necessary and should never be ommited, for the same reasons as above. The middle argument is what is interesting, this is where you specify which Live Device Parameter you want to control and observe. Parameters are always scaled 0. to 1., so you can directly use almost any Lemur object and it will immediately be useable with a Device Parameter.",
					"linecount" : 7,
					"id" : "obj-8",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 371.0, 232.0, 418.0, 103.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 371.0, 230.0, 415.0, 105.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "This abstraction gets the OSC information from a Lemur object. In this example, there is a CustomButton called \"DeviceOn\" and when it sends its parameter \"x\", it will come out of this abstraction. It's very important to leave '#1' as a prefix to your objects, as this is how the system knows if the jzlib is loaded in the top or bottom slot of the template. The '#2' argument is also very important, it carries the '---' unique instance number that makes communication local to this M4L device.",
					"linecount" : 7,
					"id" : "obj-6",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 371.0, 106.0, 418.0, 103.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 196.0, 190.0, 179.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 189.0, 170.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 371.0, 104.0, 415.0, 105.0 ]
				}
